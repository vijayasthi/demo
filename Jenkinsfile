pipeline {
	...
	stage('Sonarqube') {
		environment {
			...
			bat 'C:/sonar-scanner-cli-4.2.0.1873-windows/sonar-scanner-4.2.0.1873-windows/bin/sonar-scanner C:/Program Files (x86)/Jenkins/workspace/demo_master/build/classes/java/main/demo \
